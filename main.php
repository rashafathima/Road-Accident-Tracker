...
<nav class="navbar">
        <div class="max-width">
            <div class="logo"><i class="fa fa-car" aria-hidden="true"></i><a href="#"><span>Street's On Fire</span></a></div>
            <ul class="menu">
              <li><a href=""><button onclick="signOut()" style="background-color: #000; background: transparent; border-radius: 15px; border-color: transparent">LogOut</button></a></li>
