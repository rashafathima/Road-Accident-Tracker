  ...
  <div class="login-wrap">
    <div class="login-html"> 
        ...
        <form name="f1" action = "signinserv.php" onsubmit = "return validation()" method = "POST">  
          <div class="sign-in-htm">
            <div class="group">
              ...
              <input id="userid" type="text" name="UID" placeholder="UserID: e.g.U-100" class="input">
            </div>
            <div class="group">
        ...
        <div class="sign-up-htm">
          <div class="group">
            <label for="userid" class="label">UserID</label>
            <input id="userid" type="text" class="input" name="UID" placeholder="UserID: e.g.U-100" pattern="U-\d\d\d" >
          </div>
          <div class="group">
            <label for="user" class="label">Username</label>
